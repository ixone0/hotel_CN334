...
export default function RoomTypeC() {
  ...
  return (
    <div className="p-4">
      {/* Room Info */}
      <div className="mb-6">
        <h2 className="text-2xl font-extrabold text-slate-900 mb-2 tracking-tight">Type C</h2>
      ...
      <div className="h-48 bg-gradient-to-br from-stone-100 to-amber-50 border border-amber-100 shadow-sm rounded-lg flex items-center justify-center mb-6">
        <div className="text-center">
          <div className="text-slate-600 font-bold uppercase tracking-widest text-sm mb-2">Type C</div>
