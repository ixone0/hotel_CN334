...
export default function RoomDetailPage() {
    ...
    return (
      <div className="min-h-screen bg-slate-50 font-sans">
        ...
        <div className="max-w-3xl mx-auto px-4 py-12 text-center">
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-amber-100 inline-block">
            ...
            <button
              onClick={() => router.push('/')}
              className="px-6 py-2 bg-amber-50 text-amber-700 font-semibold rounded-full hover:bg-amber-100 transition-colors"
            >
              Back to Home
            </button>
          </div>
  ...
  return (
    // Change background to warm neutral
    <div className="min-h-screen bg-stone-50 font-sans">
      <Header title="Cn334 Hotel" />
      
      {/* Expand max-w for better room for form */}
      <div className="max-w-4xl mx-auto px-4 py-8 pb-16">
        
        {/* Header with Modern Back Button */}
        <button
          onClick={() => router.back()}
          className="mb-6 inline-flex items-center gap-2 px-4 py-2 text-slate-600 hover:text-amber-700 bg-white hover:bg-amber-50 rounded-full font-semibold text-sm transition-all shadow-sm border border-amber-200 hover:border-amber-300 active:scale-95"
        >
        ...
        {bookingStep === 'form' && (
          <div className="bg-white rounded-3xl shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] border border-amber-100 p-6 md:p-8">
            <div className="flex items-center gap-3 mb-8">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-amber-500 to-amber-700 flex items-center justify-center text-white shadow-sm">
